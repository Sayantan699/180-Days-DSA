...
// find if that element is present in the array or not.print 1 if its present else print 0.
...
int main()
{
    ...
    // sorting the array in decreask g order using bubble sort coz Binary search works only on sorted array
    for (int i = 0; i < n - 1; i++)
    {
